...
![image-20260124155050573](C:\Users\张超然\AppData\Roaming\Typora\typora-user-images\image-20260124155050573.png)
...
1. **Vertical Layout（垂直布局）**：**组件沿垂直方向（从上到下）依次排列。**
   ...
   ![image-20260124162151452](C:\Users\张超然\AppData\Roaming\Typora\typora-user-images\image-20260124162151452.png)

2. **Horizontal Layout（横向 / 水平布局）**：**组件沿水平方向（从左到右）依次排列。**

   ![image-20260124162241154](C:\Users\张超然\AppData\Roaming\Typora\typora-user-images\image-20260124162241154.png)

3. **Grid Layout（网格 / 栅格布局）**：**将界面划分为多行多列的网状栅格，组件可占用单个或多个栅格单元，灵活性极高。**

   ![image-20260124162348273](C:\Users\张超然\AppData\Roaming\Typora\typora-user-images\image-20260124162348273.png)

4. **Form Layout（表单布局）**：**专门用于表单场景，默认将 “标签 + 输入组件” 成对排列，支持灵活的换行和对齐设置。**

   ![image-20260124162514580](C:\Users\张超然\AppData\Roaming\Typora\typora-user-images\image-20260124162514580.png)
...
![image-20260124162612376](C:\Users\张超然\AppData\Roaming\Typora\typora-user-images\image-20260124162612376.png)
...
![image-20260124164005139](C:\Users\张超然\AppData\Roaming\Typora\typora-user-images\image-20260124164005139.png)
...
![image-20260124171528379](C:\Users\张超然\AppData\Roaming\Typora\typora-user-images\image-20260124171528379.png)
